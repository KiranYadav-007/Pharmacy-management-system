...
?>
	...
	<?php
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Purchase details</h2>
		
		<div style="text-align:center;"> <img src="image\medicinemain.png">  </div>
		
		<div class="container">
			<form action="add_purchase_action.php" method = "get">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="userid" placeholder="Enter User_ID...">
					</div>
				</div>
