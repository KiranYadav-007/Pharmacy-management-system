...
<?php
		...
		$sql = "INSERT INTO medicine_database (medicine_name, pharm_id, quantity, expiry_date, amount) 
		VALUES ('$medname','$pharmid', '$qty','$exdate','$amt')";


		if ($conn->query($sql) === TRUE) {
		//echo "New record created successfully";
		echo "<div id='card'><p>Medicine Added Successfully</p><form action='pharmacist_home.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
